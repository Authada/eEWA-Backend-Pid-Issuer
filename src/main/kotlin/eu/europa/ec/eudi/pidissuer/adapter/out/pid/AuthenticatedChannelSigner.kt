...
class AuthenticatedChannelSigner(
    ...
    private val holderPublicKey: JWK
) : BaseJWSProvider(setOf(P256_ALGID, P384_ALGID, P512_ALGID)), JWSSigner {
    ...
    override fun sign(header: JWSHeader, signingInput: ByteArray): Base64URL {
        ...
        if (!supportedJWSAlgorithms().contains(alg)) {
            ...
            val hmac = try {
                val sharedSecret = ECDH.deriveSharedSecret(holderPublicKey.toECKey().toECPublicKey(), privateKey, null)
