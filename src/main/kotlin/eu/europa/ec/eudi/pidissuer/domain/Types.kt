...
import de.bund.bsi.eid.AttributeRequestType
...
value class Scope(val value: String) {
    fun springConvention() = "SCOPE_$value"
}
...
data class AttributeDetails(
    ...
    val operationSetter: KFunction2<OperationsRequestorType, AttributeRequestType, Unit>? = null
)
